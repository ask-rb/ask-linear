# MASTER_GOAL.md — ask-linear

## Purpose

This is the **master goal** for building ask-linear. It does not implement the gem
directly. It loads and follows the detailed build plan at:

> **GOAL.md:** `/Users/kaka/Code/ask-rb/ask-linear/GOAL.md`
...
- **Source:** `/Users/kaka/Code/ask-rb/ask-linear/lib/`
- **Tests:** `/Users/kaka/Code/ask-rb/ask-linear/test/`
- **Goal:** `/Users/kaka/Code/ask-rb/ask-linear/GOAL.md`
- **Remote:** `git@github.com:ask-rb/ask-linear.git`
...
The GOAL.md at `/Users/kaka/Code/ask-rb/ask-linear/GOAL.md` contains the full
...
See the bottom of `/Users/kaka/Code/ask-rb/ask-linear/GOAL.md` for the full checklist.
